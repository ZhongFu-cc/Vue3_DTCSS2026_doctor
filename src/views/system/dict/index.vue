    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" width="500px" @close="closeDialog">
      <el-form ref="dataFormRef" :model="formData" :rules="rules" label-width="80px">
        <el-form-item label="字典名称" prop="name">
          <el-input v-model="formData.name" placeholder="請輸入字典名称" />
        </el-form-item>
        <el-form-item label="字典编码" prop="code">
          <el-input v-model="formData.code" placeholder="請輸入字典编码" />
        </el-form-item>
...
const rules = reactive({
  name: [{ required: true, message: "請輸入字典类型名称", trigger: "blur" }],
  code: [{ required: true, message: "請輸入字典类型编码", trigger: "blur" }],
});
